...
public class AllOnlineUsersActivity extends ListActivity {
    ...
    private static class EfficientAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.moishdLogo = (ImageView) convertView.findViewById(R.id.moishdLogo);
            ...
            holder.moishdLogo.setImageBitmap((position & 1) == 1 ? mIcon1 : mIcon2);
