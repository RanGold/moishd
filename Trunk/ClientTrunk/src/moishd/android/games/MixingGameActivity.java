...
public class MixingGameActivity extends GameActivity{
	...
	private String mix1(String str){
	...
	private String mix2(String str){
		int length = str.length();
		String result = "";
	...
	private String mix3(String str){
		String result="";
		int length = str.length();
	...
	private class LittleCount extends CountDownTimer {
